		...
		<div class="content__row">
			<?php
				...
				<div class="content__text">
					...
					<?php
					echo get_sub_field('normal_content');
					?>
				...
				<?php
					...
					$double_lists = get_sub_field('double_lists');

					$double_lists === 'yes' ? $list = 'content__lists' : $list = '' ;
					
				?>
				<div class="content__dual <?php echo $list; ?>">
					<div class="content__dual--left content__dual--<?php echo $left_content; ?>">
						<?php
					...
					<div class="content__dual--right content__dual--<?php echo $right_content; ?>">
